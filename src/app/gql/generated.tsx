...
export type GetRepositoryQuery = (
  ...
  & { repository?: Maybe<(
    { __typename?: 'Repository' }
    & Pick<Repository, 'id' | 'description' | 'homepageUrl' | 'name' | 'url' | 'openGraphImageUrl'>
    & { owner: (
      { __typename?: 'Organization' }
      & Pick<Organization, 'id' | 'login' | 'avatarUrl'>
    ) | (
      { __typename?: 'User' }
      & Pick<User, 'id' | 'login' | 'avatarUrl'>
    ), pullRequests: (
      { __typename?: 'PullRequestConnection' }
...
export type GetIssueDetailsQuery = (
  { __typename?: 'Query' }
  & { repository?: Maybe<(
    { __typename?: 'Repository' }
    & Pick<Repository, 'id' | 'url'>
    & { issue?: Maybe<(
      { __typename?: 'Issue' }
      & Pick<Issue, 'id' | 'url' | 'title' | 'bodyHTML' | 'createdAt'>
      & { author?: Maybe<(
        { __typename?: 'Bot' }
...
export type GetIssuesQuery = (
  ...
  & { search: (
    ...
    & { nodes?: Maybe<Array<Maybe<{ __typename?: 'App' } | { __typename?: 'Discussion' } | (
      { __typename?: 'Issue' }
      & Pick<Issue, 'number' | 'title' | 'createdAt' | 'id'>
      & { author?: Maybe<(
        { __typename?: 'Bot' }
 ...
 * });
 */
export function useGetIssueDetailsQuery(baseOptions: Apollo.QueryHookOptions<GetIssueDetailsQuery, GetIssueDetailsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetIssueDetailsQuery, GetIssueDetailsQueryVariables>(GetIssueDetailsDocument, options);
      }
export function useGetIssueDetailsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetIssueDetailsQuery, GetIssueDetailsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetIssueDetailsQuery, GetIssueDetailsQueryVariables>(GetIssueDetailsDocument, options);
        }
...
export type GetIssueDetailsQueryResult = Apollo.QueryResult<GetIssueDetailsQuery, GetIssueDetailsQueryVariables>;
